...
def logo():
    ...
    banner_with_ikon = f"{Colorate.Horizontal(Colors.rainbow, Center.XCenter(banner))}   {Colorate.Horizontal(Colors.rainbow, Center.XCenter(ikon))}"
    print(banner_with_ikon)
select = input(f'{COLOR_CODE["CYAN"]}[+]{COLOR_CODE["BOLD"]} НАЖМИ enter {COLOR_CODE["CYAN"]} ')
...
def main():
    ...
    if choice == '1':
        ...
        os.system("python reporter/reporter.py")
    elif choice == "9":
        os.system("python reporter/report.py")
    elif choice == "9":
